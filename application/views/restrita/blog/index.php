...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card-header py-3">
            <a title="Cadastrar novo post" href="<?php echo base_url('restrita/blog/add'); ?>" class="btn btn-success btn-sm float-right" > <i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
        </div>
        <div class="card-body">
        <div class="table-responsive">
            ...
            <?php foreach($blog as $b): ?>
                <tr>
                    ...
                    <td><?php echo $b->blog_descricao ?></td>
