      ...
      <div class="card-body">
        <form method="post" name="form_edit">
            ...
            <div class="form-group row">
              <div class="col-md-4">
                <label>Titulo</label>
                <input type="text" class="form-control" name="service_titulo" placeholder="Servico titulo.." value="<?php echo $services->service_titulo; ?>">
                <?php echo form_error('service_titulo','<small class="form-text text-danger">','</small>',''); ?>  
              </div>
              <div class="col-md-8">
                <label>Descricão</label>
                <input type="text" class="form-control" name="service_descricao" placeholder="Servico descrição..." value="<?php echo $services->service_descricao; ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5">
                ...
                <input type="text" class="form-control" name="service_icona" placeholder="Servico icona..." value="<?php echo $services->service_icona; ?>">
              ...
              <div class="col-md-7">
                  ...
                  <input type="text" class="form-control" placeholder="<i></i>" value="<i class='flaticon-industrial-robot'></i>" disabled>
        ...
        <input type="hidden" class="form-control" name="service_id" placeholder="" value="<?php echo $services->service_id; ?>">
